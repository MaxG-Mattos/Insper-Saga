...
from configuracoes import QUIT, TELA, RUNNING5
pygame.init()
font = pygame.font.SysFont('arial', 30)
titulo = "Tome um minuto para respirar, o Resina está te aguardando"
...
pos = (170, 540)
dramatis = (100, 200) #posição do título
FPS = 60
BLACK = (0,0,0)
class Blink():
...
def intervalo(window):
    window = window
    vel = pygame.time.Clock()
    running = True
    state = None
    pygame.mixer.music.load(musica['quarta fase'])
